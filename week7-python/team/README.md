...
- `week7_rfm_complete.ipynb` - team notebook for loading UrbanStyle customer
  and sales data, cleaning the joined dataset, calculating RFM metrics, creating
  customer segments, visualizing results, and exporting segment data.
