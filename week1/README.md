...
Week 1 focused on exploring UrbanStyle's database with SQL, understanding the structure of the `sales`, `customers`, and `products` tables, and contributing to the group presentation based on verified findings.

## My contribution

- Worked on **Role A - Muugitehingud** (`sales`: sums and dates)
- Queried the `sales` table using SQL in Supabase
- Verified row counts, duplicates, missing values, and transaction extremes
- Replaced inaccurate AI-generated notes with checked SQL results
