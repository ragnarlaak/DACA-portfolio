-- Nadal 1 individuaalne SQL praktika
-- Isiklikud SQL harjutused nadalast 1

-- 10 esimest rida Tartu muukidest, kus summa on mitte rohkem kui 200
SELECT *
FROM sales
...
-- Toomase duplikaatide mure:
-- arvete koguarv, unikaalsete arvete arv ja duplikaadid
SELECT
  COUNT(*) AS ridade_arv,
...
FROM sales
ORDER BY status;
-- Millised staatused on esindatud? Veergu "status" ei ole.
